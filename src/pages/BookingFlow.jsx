    ...
    const fetchHospitalsAndDoctors = async () => {
      try {
        ...
        const hospitalsResponse = await fetch(
          url_prefix + "/api/hospitals/all?limit=10000"
        );
  ...
  const fetchDoctors = async (hId) => {
    try {
      const doctorsResponse = await fetch(
        `${url_prefix}/api/doctors/hospital/${hId}`
      );
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                Ask questions about treatments or services
              </p>
          ...
          {!isLoggedIn && (
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <p className="text-sm text-gray-600 mb-2">
                <strong>Already have an account?</strong> Login to access your
                medical history and faster booking.
              </p>
          ...
          {bookingType === "appointment" && !isLoggedIn && (
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg mb-3">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> You'll need to login or create an account
                to confirm your appointment. This helps us keep your medical
                records secure.
              </p>
            </div>
          )}
          ...
          {bookingType === "appointment" && !isLoggedIn && (
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg mb-4">
              <p className="text-sm text-yellow-800 mb-2">
                <strong>Final step:</strong> Please login or create an account
